...
var _user$project$Chat$viewMessages = function (messages) {
	var itemMessage = function (m) {
		return A2(
	...
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (m) {
				return itemMessage(m);
			},
			messages));
};
var _user$project$Chat$Model = F3(
	function (a, b, c) {
		return {messages: a, typedMessage: b, phxSocket: c};
	});
		...
		switch (_p0.ctor) {
			...
			case 'SendMessage':
				var payload = _elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'body',
							_1: _elm_lang$core$Json_Encode$string(model.typedMessage)
						}
						]));
				var push$ = A2(
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{typedMessage: '', phxSocket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Chat$PhoenixMsg, phxCmd)
				};
			case 'ReceiveChatMessage':
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Chat$chatMessageDecoder, _p0._0);
				if (_p2.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								messages: A2(_elm_lang$core$List_ops['::'], _p2._0.body, model.messages)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'JoinChannel':
				var channel = _fbonetti$elm_phoenix_socket$Phoenix_Channel$init('rooms:lobby');
...
var _user$project$Chat$TypeMessage = function (a) {
	return {ctor: 'TypeMessage', _0: a};
};
...
var _user$project$Chat$initialModel = {
	messages: _elm_lang$core$Native_List.fromArray(
		[]),
	typedMessage: '',
	phxSocket: _user$project$Chat$initPhxSocket
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('hello chat')
					])),
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(_user$project$Chat$TypeMessage),
								_elm_lang$html$Html_Attributes$value(model.typedMessage)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				_user$project$Chat$viewMessages(model.messages)
			]));
};
var _user$project$Chat$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Chat$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			update: _user$project$Chat$update,
			view: _user$project$Chat$view,
			subscriptions: _user$project$Chat$subscriptions
		})
};
